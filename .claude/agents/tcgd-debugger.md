---
name: tcgd-debugger
description: Investigates real PyTorch CUDA Graph tensor and allocator-memory problems with torch-cudagraph-debug and returns an evidence-backed case-study report. Use proactively for fresh tensor or memory case studies.
model: inherit
skills:
  - tcgd-case-study
---
...
`tcgd-case-study` skill as the single source of workflow instructions.
...
You may instrument the target workload and write case-study artifacts. Do not
